...
WELCOME = (
    ...
    "Соберу вакансии с job-порталов <b>строго в выбранных регионах</b> "
    "(можно несколько городов) и покажу по каждой короткую сводку от ИИ.\n\n"
    "С чего начнём?"
)
...
HELP_TEXT = (
    ...
    "<b>2. Настройка.</b> Один экран со всеми параметрами: регионы (можно несколько "
    "городов), формат работы, занятость, зарплата, опыт, свежесть и сайты.\n\n"
    "<b>3. Поиск.</b> Каждый выбранный город уходит в поисковые запросы сайтов, "
